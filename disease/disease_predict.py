...
import numpy as np
final_svm_model= joblib.load(r"D:\education\HTML\disease\static\final_nb_model.sav")
final_rf_model = joblib.load(r"D:\education\HTML\disease\static\final_rf_model.sav")
final_nb_model = joblib.load(r"D:\education\HTML\disease\static\final_nb_model.sav")
...
if __name__ == "__main__":
    symptom = "Diarrhoea,Muscle Weakness,Receiving Blood Transfusion"
    print(predictDisease(symptom))
